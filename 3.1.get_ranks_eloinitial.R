...
initial.ranks.north <- informed_elo(contestants = filter(contestants.north, period == 2009),
                                    convention = 'none',
                                    interactions = filter(interactions.north, period == 2009))$id
...
initial.ranks.south <- informed_elo(contestants = filter(contestants.south, period == 2009),
                                    convention = 'none',
                                    interactions = filter(interactions.south, period == 2009))$id
...
initial.ranks.hz <- informed_elo(contestants = filter(contestants.hz, period == 2009),
                                    convention = 'none',
                                    interactions = filter(interactions.hz, period == 2009))$id
...
initial.ranks.talek <- informed_elo(contestants = filter(contestants.talek, period == 1988),
                                    convention = 'none',
                                    interactions = filter(interactions.talek, period == 1988))$id
...
save(ranks, file = '4.ranks.elo.RData')
